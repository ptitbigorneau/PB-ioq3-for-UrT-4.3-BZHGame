...
=======================================================================================================
*/
static void PB_Nospace(char *name)
{
...
=================================================================================================
*/
            else if (Q_stricmp("give", Cmd_Argv(0)) == 0) {
				return;
			}
            else if (Q_stricmp("god", Cmd_Argv(0)) == 0) {
				return;
			}
            else if (Q_stricmp("noclip", Cmd_Argv(0)) == 0) {
				return;
			}
            else if (Q_stricmp("notarget", Cmd_Argv(0)) == 0) {
				return;
			}
            else if (Q_stricmp("levelshot", Cmd_Argv(0)) == 0) {
				return;
			}
/*
=================================================================================================
